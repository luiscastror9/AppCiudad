...
namespace Net.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private ApplicationRoleManager _roleMaganer;
        ...
        public ActionResult CreateRole(RoleViewModel model)
        {
            ...
            //verificamos si el rol ya existe usando rolemanager
            if (RoleManager.RoleExists(model.Name))
            {
                //retornamos algun error informando que el rol ya existe
            }
            ...
            //aca devuelve el modelo a la vista
            // 
            return View(model);
        }
    ...
    [HttpPost]
        ...
        public ApplicationRoleManager RoleManager
        {
            get
            {
                return _roleMaganer ?? HttpContext.GetOwinContext().Get<ApplicationRoleManager>();
            }
            private set
            {
                _roleMaganer = value;

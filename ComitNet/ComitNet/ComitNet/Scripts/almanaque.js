...
*/
    ...
    this.size = size;
        ...
        label = ["Domingo", "Lunes", "Martes", "Wednesday", "Jueves", "Viernes", "Sabado"];
    ...
    Calendar.prototype.draw = function () {
        backSvg = '<svg style="width: 24px; height: 24px;" viewBox="0 0 24 24"><path fill="' + this.colors[2] + '" d="M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z"></path></svg>';
    nextSvg = '<svg style="width: 24px; height: 24px;" viewBox="0 0 24 24"><path fill="' + this.colors[2] + '" d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z"></path></svg>';
    ...
    theContainers[i].className = theNames[i];
            ...
            if (theNames[i] != "days") {
                if (theNames[i] != "month") {
        theContainers[i].style.backgroundColor = "#333";
    theContainers[i].style.color = "#40CCDC";
    ...
    Organizer.prototype.draw = function () {
        backSvg = '<svg style="width: 24px; height: 24px;" viewBox="0 0 24 24"><path fill="' + this.calendar.colors[2] + '" d="M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z"></path></svg>';
    nextSvg = '<svg style="width: 24px; height: 24px;" viewBox="0 0 24 24"><path fill="' + this.calendar.colors[2] + '" d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z"></path></svg>';
    ...
    var calendar = new Calendar("calendarContainer", "small", ["Wednesday", 3], ["#ffffff", "#333    ", "#ffffff", "#40CCDC"]);
    ...
    data = {
        ...
        startTime: "6:00",
                                        endTime: "7:00",
                                        mTime: "am",
                                        text: "Tomatina.´Fiesta Nacional del Tomate´"
                                    },
